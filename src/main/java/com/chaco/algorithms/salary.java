...
public class salary {
    ...
    public static void salaryRates() {
        ...
        BigDecimal kePreHaltHour = keS.divide(new BigDecimal(keHaltHours), 4, RoundingMode.HALF_DOWN);
        System.out.println("ke.salaryRates:" + kePreHaltHour);
        System.out.println("==============================================================");

        BigDecimal didiS = new BigDecimal("27000");
        int didiHaltHours = 23;//11:00 ~ 21:00
        BigDecimal didiPreHaltHour = didiS.divide(new BigDecimal(didiHaltHours), 4, RoundingMode.HALF_DOWN);
        System.out.println("didi.salaryRates:" + didiPreHaltHour);
        System.out.println("==============================================================");

        BigDecimal mcS = new BigDecimal("33000");
        int mcHaltHours = 13;//11:30 ~ 18:00
        BigDecimal mcPreHaltHour = mcS.divide(new BigDecimal(mcHaltHours), 4, RoundingMode.HALF_DOWN);
